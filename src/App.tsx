...
export default function App() {
  ...
  const isAdmin = location.pathname === "/anbproject"
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ✅ footer도 관리자 페이지에서는 full width */}
      <footer className={isAdmin ? "w-full py-10 text-center text-neutral-500 text-sm" : "container py-10 text-center text-neutral-500 text-sm"}>
